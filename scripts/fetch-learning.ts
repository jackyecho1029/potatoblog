...
async function summarizeVideo(originalTitle: string, transcriptText: string): Promise<{ hookTitle: string, summary: string }> {
    ...
    const prompt = `
你是一位专业的内容创作者和学习助手。请完成以下任务：
1. 创建一个引人入胜、激发好奇心的中文标题（不是直译）
2. 总结视频内容
...
---HOOK_TITLE_START---
[写一个简短有力的中文标题，激发好奇心或制造紧迫感。使用反问句、大胆声明或引人入胜的钩子。例如："为什么90%的人永远无法财务自由？" 或 "这个习惯，让我一年多赚了50万"]
---HOOK_TITLE_END---
